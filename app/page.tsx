      ...
      <header className="dark sticky top-0 z-50 w-full border-b border-white/50 dark:border-slate-600/60 bg-white/30 dark:bg-slate-900/30 backdrop-blur-xl transition-all shadow-[0_4px_30px_rgba(0,0,0,0.05)] shadow-inner">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-8">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-black text-slate-800 dark:text-slate-200">
            <Link href="#features" className="hover:text-pink-600 transition-colors py-1.5 px-4 rounded-full drop-shadow-md text-slate-800 dark:text-slate-200">Features</Link>
            <Link href="#vision" className="hover:text-pink-600 transition-colors py-1.5 px-4 rounded-full drop-shadow-md text-slate-800 dark:text-slate-200">Vision</Link>
            <Link href="#tech-stack" className="hover:text-pink-600 transition-colors py-1.5 px-4 rounded-full drop-shadow-md text-slate-800 dark:text-slate-200">Tech Stack</Link>
          </nav>
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            ...
            {user ? (
              <div className="flex flex-col sm:flex-row items-end sm:items-center gap-1 sm:gap-3">
                ...
                <Link
                  href="/dashboard"
                  className="h-7 sm:h-9 inline-flex items-center rounded-xl bg-pink-500/90 hover:bg-pink-600 px-3 sm:px-5 text-[10px] sm:text-sm font-black text-white transition-all shadow-lg shadow-pink-500/30 border border-pink-400/50"
                >
                  Dashboard
                </Link>
                <button
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 ml-1 sm:ml-2">
                ...
                <Link
                  href="/signup"
                  className="h-8 sm:h-9 inline-flex items-center rounded-xl bg-pink-500/90 hover:bg-pink-600 px-2.5 sm:px-5 text-[11px] sm:text-sm font-black text-white transition-all shadow-xl shadow-pink-500/30 border border-pink-400/50"
                >
                  Start
                </Link>
              </div>
